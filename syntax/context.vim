...
hi def link contextBlockDelim Special
hi def link contextBuiltin    Special
...
hi contextEscaped gui=italic guifg=grey
...
let &cpo = s:cpo_save
unlet s:cpo_save
"syn match ContextSection /^\\section{[^}\n]*}.*$/
"syn match ContextSubSection /^\\subsection{[^}\n]*}/
"syn match ContextSubSubSection /^\\subsubsection{[^}\n]*}/
hi ContextSection      gui=bold 
hi ContextSubSection   gui=bold
hi ContextSubSubSection gui=bold 
